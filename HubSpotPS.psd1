#
# Module manifest for module 'HubSpotPS'
#
...
Description = 'A PowerShell module that makes interfacing with HubSpot a little easier'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'HubSpot','HubSpotPS','HubSpotApi','HubSpotCrm','Marketing','CRM','Events'
